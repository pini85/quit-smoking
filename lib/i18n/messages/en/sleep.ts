export const sleep = {
  ...
  results: {
    ...
    vsBaselineDown: 'Last night vs. your baseline: ↓ {percent}%',
    vsBaselineUp: 'Last night vs. your baseline: ↑ {percent}%',
    vsBaselineFlat: 'Last night vs. your baseline: ≈ about the same',
    vsBaselineDown7: 'Last 7 nights vs. your baseline: ↓ {percent}%',
    vsBaselineUp7: 'Last 7 nights vs. your baseline: ↑ {percent}%',
    vsBaselineFlat7: 'Last 7 nights vs. your baseline: ≈ about the same',
  },
  trends: {
    title: 'Snore trends',
    empty:
    ...
    comparison: {
      ...
      sevenNights: 'Last {nights} nights',
      baselinePreQuit: 'Before you stopped smoking',
      baselineFirstNights: 'Your first nights',
    },
    delta: {
